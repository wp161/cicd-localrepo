...
| Task                                                                                                                            | Weight |
| ------------------------------------------------------------------------------------------------------------------------------- | ------ |
| [[DB] Set up and configure the PostgreSQL DB for Kubernetes Cluster](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/65)               | 2      |
| [(last sprint)Update CLI Design and Backend Design align with Solution Proposal for Config File Handling in the CICD Backend Validation](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/58)               | 2      |
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|--------|----------------|
| [(last sprint)Refactor Backend ConfigValidation, ConfigController, PipelineController and relevant Service](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/56)                              | In Review   | 3      | Yuhan          |
| [[CLI] Refactor CLI to use relative path in API call](https://github.com/CS6510-SEA-F24/t3-cicd-cli/issues/67)                                                                                        | In Review   | 2      | Wenbo          |
| [[ConfigService] Extract ConfigService for Kubernetes Deployment](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/63)                                                                        | In Progress | 3      | Wenbo          |
| [[PipelineService] Extract PipelineService for Kubernetes Deployment](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/64)                                                                    | Ready       | 2      | Kelvin & Yuhan |

# New tasks

| Task                                                                                                                         | Weight | Assignee |
|------------------------------------------------------------------------------------------------------------------------------|--------|----------|
| [[K8s] Configure Ingress Controller](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/66)                            | 3      | TBD      |
| [[K8s] Configure Argo DAG Workflows for pipeline job execution](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/67) | 5      | TBD      |
| [[K8s] Configure Helm to automate K8s deployment](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/68)               | 2      | TBD      |


# What worked this week?

- This week, we started migrating our monolithic service to microservices on Kubernetes. Although none of us had prior experience breaking down a monolithic service or implementing solutions on Kubernetes, the team collaborated effectively by sharing starter code based on our research, allowing others to refer to it and speed up their respective tasks.
- Code reviews have become more thorough, leading to the identification and resolution of bugs in each other's work. This is helping us maintain a high standard of code quality.

# What did not work this week?

- 1 tickets from the last sprint are delayed again this sprint. To support the assignee in getting back on track, we reallocated resources and assigned one developer to take over a new ticket on their behalf.
- A significant amount of time was spent exploring the best way to split the monolithic repository into microservices. Key decisions around dependencies (e.g., which components should be independent, which should depend on others, and how to reflect these dependencies in Gradle build file and Dockerfiles) are proving complex and time-intensive. Since this process is new to the team, the learning curve has impacted our overall speed.
