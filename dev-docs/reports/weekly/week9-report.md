...
| Task                                                                                                                            | Weight |
| ------------------------------------------------------------------------------------------------------------------------------- | ------ |
| [(last sprint)Refactor Backend ConfigValidation, ConfigController, PipelineController and relevant Service](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/56)               | 3      |
| [[CLI] Refactor CLI to use relative path in API call](https://github.com/CS6510-SEA-F24/t3-cicd-cli/issues/67)               | 2      |
| [[ConfigService] Extract ConfigService for Kubernetes Deployment](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/63)  | 3   |
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|--------|----------------|
| [[PipelineService] Extract PipelineService for Kubernetes Deployment](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/64)                                                                    | In Progress       | 2      | Kelvin & Yuhan |
| [[K8s] Configure Ingress Controller](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/66)                                                                        | In Review | 3      | Wenbo          |
| [[K8s] Configure Argo DAG Workflows for pipeline job execution](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/67)                                                                        | In Progress | 3      | Kelvin & Yuhan          |
...
- Communication was effective between Kelvin and Yuhan since both are working together on extracting the pipeline service and working on K8s service
...
-Teammates have been busy this week with external obligations like job interviews and cancelling of travel plans as well as surviving the aftermath of the bomb cyclone - some teammates had no access to power and electricity for a period of time
- A significant amount of time was spent exploring how to add the dependency to use the argo-client-java library and how to use the library once the dependencies were added
