...
| Task                                                                                                                                                                         | Weight |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|
| [Create an API and controller to handle pipeline run request from the CLI](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/24) | 3      |
| [[ConfigService] Add line and col in error message](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/33)                | 3      |
| [[Config File] Decide how to get the config file in the backend](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/32)                                                             | 2      |
| [[DockerService] Add Docker registry](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/34)                      | 2      |

# Carry over tasks

| Task                                                                                                                                    | Status          | Weight | Assignee |
|-----------------------------------------------------------------------------------------------------------------------------------------|-----------------|--------|----------|
| [[CLI] Refactor CLI options to capture new requirements](https://github.com/CS6510-SEA-F24/t3-cicd-cli/issues/49)                       | In Review     | 2      | Yuhan |
| [Update CLI Design and Backend Design align with Solution Proposal for Config File Handling in the CICD Backend Validation](https://github.com/CS6510-SEA-F24/t3-cicd-cli/issues/58)           | In review       | 2      | Yuhan    |
| [[DockerService] Use jobs in jobOrder to create Docker containers](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/38)           | In Progress       | 2      | Kelvin    |
...
| [[DB] Finalize Database Design and what we want to store](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/7)                | TBD    | TBD      |
| [Create a Public Image to Test CI/CD Pipeline Run](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/46)                | TBD    | TBD      |
| [Run Real Custom Scripts in Running Docker Containers and Verify the Results](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/47)                | TBD    | TBD      |
| [Collect the Logs from the Docker Container and Upload Information to a Database Table](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/48)                | TBD    | TBD      |
| [Decide on a Database Schema to Store Logs](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/49)                | TBD    | TBD      |
| [[KubernetesService] Migrate Current Implementation of Manually Starting Docker Containers to an Implementation of Creating Multiple Containers on Kubernetes](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/50)                | TBD    | TBD      |
| [[DockerService] Assign an Unused Port Number When Docker Containers are Created](https://github.com/CS6510-SEA-F24/t3-cicd-backend/issues/51)                | TBD    | TBD      |

# What worked this week?

- Most of the carried-over tickets from last week were successfully reviewed and merged in to the `main` branch.
- Pull requests were reviewed and approved in a very timely manner
...
- We successfully resolved internal conflicts between teammates
